...
@Entity
@Table(name = "Guest_Health_Binah_Detail")
public class GuestHealthBinahDetail {

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "guestHealthBinaDetailSeqGen")
	@SequenceGenerator(name = "guestHealthBinaDetailSeqGen", sequenceName = "guest_health_Binah_detail_sequence", initialValue = 1000000000, allocationSize = 1)
	@Column(name = "guest_health_Binah_detail_id", length = 10, unique = true)
	private Long guestHealthBinahDetailId;
	...
	public GuestHealthBinahDetail() {
		super();
	}

	public GuestHealthBinahDetail(Long guestHealthBinahDetailId, String userEmail, String pulseRate,
			String respirationRate, String oxygenSaturation, String sdnn, String stressLevel,
			String bloodPressure, String stressIndex, String meanRri, String rmssd, String sd1, String sd2, String prq,
			String pnsIndex, String pnsZone, String snsIndex, String snsZone, String wellnessIndex,
			String wellnessLevel, String lfhf, String hemoglobin, String hemoglobinA1C, String highHemoglobinA1CRisk,
			String highBloodPressureRisk, String ascvdRisk, String normalizedStressIndex, String heartAge,
			String highTotalCholesterolRisk, String highFastingGlucoseRisk, String lowHemoglobinRisk, String registDate,
			String registPName, String lastUpdateDate, String lastUpdatePName, Guest guest) {
		super();
		this.guestHealthBinahDetailId = guestHealthBinahDetailId;
	...
	public Long getGuestHealthBinahDetailId() {
		return guestHealthBinahDetailId;
	}

	public void setGuestHealthBinahDetailId(Long guestHealthBinahDetailId) {
		this.guestHealthBinahDetailId = guestHealthBinahDetailId;
	}
	...
	public String toString() {
		return "GuestHealthBinahDetail [guestHealthBinahDetailId=" + guestHealthBinahDetailId + ", userEmail="
				+ userEmail + ", pulseRate=" + pulseRate + ", respirationRate=" + respirationRate
				+ ", oxygenSaturation=" + oxygenSaturation + ", sdnn=" + sdnn + ", stressLevel=" + stressLevel
				+ ", bloodPressure=" + bloodPressure + ", stressIndex=" + stressIndex + ", meanRri="
				+ meanRri + ", rmssd=" + rmssd + ", sd1=" + sd1 + ", sd2=" + sd2 + ", prq=" + prq + ", pnsIndex="
				+ pnsIndex + ", pnsZone=" + pnsZone + ", snsIndex=" + snsIndex + ", snsZone=" + snsZone
				+ ", wellnessIndex=" + wellnessIndex + ", wellnessLevel=" + wellnessLevel + ", lfhf=" + lfhf
				+ ", hemoglobin=" + hemoglobin + ", hemoglobinA1C=" + hemoglobinA1C + ", highHemoglobinA1CRisk="
				+ highHemoglobinA1CRisk + ", highBloodPressureRisk=" + highBloodPressureRisk + ", ascvdRisk="
				+ ascvdRisk + ", normalizedStressIndex=" + normalizedStressIndex + ", heartAge=" + heartAge
