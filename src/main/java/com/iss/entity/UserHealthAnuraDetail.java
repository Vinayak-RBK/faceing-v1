...
@Entity
@Table(name = "user_health_anura_detail")
public class UserHealthAnuraDetail {

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "userHealthAnuraDetailSeqGen")
	@SequenceGenerator(name = "userHealthAnuraDetailSeqGen", sequenceName = "user_health_anura_details_sequence", initialValue = 1000000000, allocationSize = 1)
	@Column(name = "user_health_anura_detail_id", length = 10, unique = true)
	private Long userHealthAnuraDetailId;
	...
	// Default constructor
	public UserHealthAnuraDetail() {
		super();
	}

	public UserHealthAnuraDetail(Long userHealthAnuraDetailId, String userEmail, String age, String hRBPM,
		...
		super();
		this.userHealthAnuraDetailId = userHealthAnuraDetailId;
	...
	public Long getUserHealthAnuraDetailId() {
		return userHealthAnuraDetailId;
	}

	public void setUserHealthAnuraDetailId(Long userHealthAnuraDetailId) {
		this.userHealthAnuraDetailId = userHealthAnuraDetailId;
	}
	...
	public String toString() {
		return "UserHealthAnuraDetail [userHealthAnuraDetailId=" + userHealthAnuraDetailId + ", userEmail=" + userEmail
				+ ", age=" + age + ", hRBPM=" + hRBPM + ", bPSystolic=" + bPSystolic + ", hRVSDNN=" + hRVSDNN
				+ ", bPRPP=" + bPRPP + ", bPTau=" + bPTau + ", healthScore=" + healthScore + ", mentalScore="
				...
				+ ", lastUpdateDate=" + lastUpdateDate + ", lastUpdatePName=" + lastUpdatePName + ", endUser=" + endUser
				+ "]";
	}
