...
public class UserHealthDetailsResponseDao {
	...
	private List<HealthRequestDao> values;
	...
	public List<HealthRequestDao> getValues() {
		return values;
	}

	public void setValues(List<HealthRequestDao> values) {
		this.values = values;
	}
