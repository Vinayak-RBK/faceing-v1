...
public class LoginUserServiceImpl implements LoginUserService {
	...
	public ResponseDao findByEmailId(UserDao userDao, boolean isForLogin, String dateTimeFormat) throws Exception {
		...
		logger.info("While USer Login for Email Id {} and Password {} - {}",userDao.getEmailId(),userDao.getPassword(), resDao.getMessage());
		return resDao;
	}
...
//						// Copying fetched values from DB to dao.
		...
		logger.info("While Verifying user in verifyUser() method - {}", resDao.getMessage());
		return resDao;
	}
	...
	public String getCurrentTimestamp() {
		return LocalDateTime.now().format(DateTimeFormatter.ofPattern(DateTimeFormat.getDateTimeFormat1()));
	}
	...
	public ResponseDao saveUserWithOTP(UserDao userDao, String dateTimeFormat, boolean isNewUser) {
		...
		try {
			...
			resDao.setIsSuccess(Boolean.toString(false));
			logger.error("Exception occured while saving OTP in saveUserWithOTP() method - {}",e);
			return resDao;
		}

		logger.info("While Saving OTP in saveUserWithOTP() method- {}", resDao.getMessage());
		return resDao;
	}
	...
	public ResponseDao verifyOtpForSignup(UserDao userDao, String dateTimeFormat) throws Exception {
		...
		if (user == null) {
			...
			logger.info("While verifying otp in verifyOtpForSignup() method - {}",resDao.getMessage());
			return resDao;
		} else {
	...
	public ResponseDao updatePassword(UserDao userDao, String dateTimeFormat) {
		...
		try {
			...
			logger.info("Exception occured While updating password in updatePassword() method - {}",e);
			return resDao;
		}
		...
		logger.info("While updating password in updatePassword() method - {}",resDao.getMessage());
		return resDao;
	}
	...
	public String storeOtpForForgotPassword(UserDao userDao, String dateTimeFormat) {
		...
		try {
			...
			logger.info("Exception occured While storing otp for forgot password in storeOtpForForgotPassword() method - {}",e);
		}
		return newOtp;
	}
	...
	public ResponseDao findByEmailIdForSignUp(UserDao userDao, ResponseDao resDao) {
		...
		try {
			...
			logger.info("Exception occured While finding Email Id in findByEmailIdForSignUp() method - {}",e);
		}
		if (user == null) {
			resDao.setIsOTPVerified(Boolean.toString(false));
			resDao.setIsOnBoarded(Boolean.toString(false));
		...
		logger.info("While finding Email Id in findByEmailIdForSignUp() method - {}",resDao.getMessage());
		return resDao;
	}
	...
	public UserProfileRespDao updateProfileByUserId(String userId, String dateTimeFormat, MultipartFile fileName,
		...
		try {
			...
			logger.error("Exception occured While updating Profile in updateProfileByUserId() method - {}",respDao.getMessage());
			return respDao;
		}
		...
		logger.info("While updating Profile in updateProfileByUserId() method - {}",respDao.getMessage());
		return respDao;
	}
	...
	public ResponseDao findByEmailIdForAddEmployee(EmployeeDao empDao) {
		...
		if (user != null) {
			try {
				...
				logger.error("Exception occured While finding email Id in findByEmailIdForAddEmployee() method - {}",e);
				return resDao;
			}
...
//			return resDao;
		...
		logger.info("While finding Email Id in findByEmailIdForAddEmployee() method - {}",resDao.getMessage());
		return resDao;
	}
	...
	public ResponseDao addEmployeeService(EmployeeDao empDao, String dateTimeFormat) {
		...
		logger.info("While fadding employee in addEmployeeService() method - {}",resDao.getMessage());
		return resDao;
	}
