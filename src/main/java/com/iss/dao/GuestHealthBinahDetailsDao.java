...
public class GuestHealthBinahDetailsDao {
	...
	public GuestHealthBinahDetailsDao() {
		super();
	}

	public GuestHealthBinahDetailsDao(String userEmail, String pulseRate, String respirationRate,
			String oxygenSaturation, String sdnn, String stressLevel, String bloodPressure,
			...
			String highFastingGlucoseRisk, String lowHemoglobinRisk) {
		super();
	...
	public String toString() {
		return "GuestHealthBinahDetailsDao [userEmail=" + userEmail + ", pulseRate=" + pulseRate + ", respirationRate="
				+ respirationRate + ", oxygenSaturation=" + oxygenSaturation + ", sdnn=" + sdnn + ", stressLevel="
				+ stressLevel + ", bloodPressure=" + bloodPressure + ", stressIndex=" + stressIndex
				+ ", meanRri=" + meanRri + ", rmssd=" + rmssd + ", sd1=" + sd1 + ", sd2=" + sd2 + ", prq=" + prq
				+ ", pnsIndex=" + pnsIndex + ", pnsZone=" + pnsZone + ", snsIndex=" + snsIndex + ", snsZone=" + snsZone
				...
				+ highFastingGlucoseRisk + ", lowHemoglobinRisk=" + lowHemoglobinRisk + "]";
	}
