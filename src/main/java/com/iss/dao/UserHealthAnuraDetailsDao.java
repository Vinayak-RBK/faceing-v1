...
public class UserHealthAnuraDetailsDao {
	...
	public UserHealthAnuraDetailsDao() {
		super();
	}

	public UserHealthAnuraDetailsDao(String age, String hRBPM, String bPSystolic, String hRVSDNN, String bPRPP,
			String bPTau, String healthScore, String mentalScore, String vitalScore, String physicalScore, String mSI,
			String bpHeartAttack, String bPStroke, String bPCVD, String risksScore, String sNR, String bRBPM,
			String bpDiastolic, String iHBCount, String hBA1CRiskProb, String mFBGRiskProb, String dBTRiskProb,
			String fLDRiskProb, String hDLTCRiskProb, String hPTRiskProb, String overallMetabolicRiskProb,
			String tGRiskProb, String physioScore, String registDate) {
		super();
		this.age = age;
		this.hRBPM = hRBPM;
	...
	public String toString() {
		return "UserHealthAnuraDetailsDao [age=" + age + ", hRBPM=" + hRBPM + ", bPSystolic=" + bPSystolic
				+ ", hRVSDNN=" + hRVSDNN + ", bPRPP=" + bPRPP + ", bPTau=" + bPTau + ", healthScore=" + healthScore
				...
				+ ", risksScore=" + risksScore + ", sNR=" + sNR + ", bRBPM=" + bRBPM + ", bpDiastolic=" + bpDiastolic
				+ ", iHBCount=" + iHBCount + ", hBA1CRiskProb=" + hBA1CRiskProb + ", mFBGRiskProb=" + mFBGRiskProb
				+ ", dBTRiskProb=" + dBTRiskProb + ", fLDRiskProb=" + fLDRiskProb + ", hDLTCRiskProb=" + hDLTCRiskProb
				+ ", hPTRiskProb=" + hPTRiskProb + ", overallMetabolicRiskProb=" + overallMetabolicRiskProb
				+ ", tGRiskProb=" + tGRiskProb + ", physioScore=" + physioScore + ", registDate=" + registDate + "]";
	}
